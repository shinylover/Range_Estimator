...
## Generated on : Fri Jun 25 23:14:11 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Controller0.elf
...
START_DIR                 = D:/Desktop/shifeihong
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH        = C:/Users/82724/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Controller0.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Controller0_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
%.o : $(START_DIR)/Controller0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Controller0_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Controller0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Controller0.o : $(START_DIR)/Controller0_ert_rtw/Controller0.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Controller0_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
