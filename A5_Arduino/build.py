...
cSourceList.append(projfile.ProjectFile("Controller0.c"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("periodic/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("periodic/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("periodic/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("periodic/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary RangeEsitimator.hex from RangeEsitimator")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("RangeEsitimator")
  postCommand.mCommand.append("RangeEsitimator.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "RangeEsitimator.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing RangeEsitimator on avr/arduino/uno\033[0m")
