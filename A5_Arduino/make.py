...
try:
	...
	print("goil -t=avr/arduino/uno --templates=../../../../goil/templates/ periodic.oil")
	sys.exit(1)
...
sourceList.append("periodic/tpl_dispatch_table.c")
sourceList.append("periodic/tpl_invoque.S")
sourceList.append("periodic/tpl_interrupts.c")
